...
import { Shield, Zap, Globe, Users, ChevronRight, Lock, Video } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-lg leading-tight tracking-tight">Teknologi Digital Nasional</span>
          ...
          <div className="text-sm font-medium text-gray-400 hidden md:flex items-center space-x-8">
            ...
            <button className="text-white bg-white/10 hover:bg-white/20 px-5 py-2.5 rounded-lg transition-all border border-white/5">
              Masuk
            </button>
          </div>
        </div>
